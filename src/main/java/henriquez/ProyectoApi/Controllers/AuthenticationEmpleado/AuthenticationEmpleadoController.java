...
public class AuthenticationEmpleadoController {
        ...
        if (userOpt.isPresent()) {
            ...
            String cookieValue = String.format(
                    "authToken=%s; " +
                            ...
                            "SameSite=None; " +
                            "MaxAge=86400; "+
                            "Domain=portalwebhenriquez2025-feb6aad59691.herokuapp.com",
                    token
            );
    ...
    public ResponseEntity<String> logout(HttpServletRequest request, HttpServletResponse response) {
        ...
        String cookieValue = "authToken=; Path=/; HttpOnly; Secure; SameSite=None; MaxAge=0; Domain=portalwebhenriquez2025-feb6aad59691.herokuapp.com";
